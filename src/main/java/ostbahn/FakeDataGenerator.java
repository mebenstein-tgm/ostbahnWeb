...
public class FakeDataGenerator {
    ...
    public static List<String> bahnhofNames = Arrays.asList("Wien Westbhf","Wien Hütteldorf","St. Pölten","Amstetten","Linz","Wels","Attnang-Puchheim","Salzburg");
    public static List<String> emailList = Arrays.asList("hotmail.com","gmail.com","me.com","gmx.at","brabenetz.com");
    public static List<String> vornamenListe = Arrays.asList("hans","peter","michael","franz","josef","reiner");
    public static List<String> nachnamenListe = Arrays.asList("brabenetz","pfusch","rothschild","vandevelde","duck");
